...
- **資質・ウェア・アデプト能力が連れてくる技能を、技能タブから選べるようになった。**
  買うのではなく**名前を決める**だけの技能 —— 資質の技能枠、リフレックス・レコーダの
  対象、アデプト能力〈能力向上〉の対象 —— は、それぞれを与えている側のタブ（資質、
  サイバーウェア、アデプト）に選択欄がありました。変えに行く場所としては正しいのですが、
  **見つける**場所としては誤りで、技能タブには枠があること自体どこにも出ていませんでした。
  知っている人にしか選べない設定です。同じ選択欄を技能タブの先頭にも並べ、どれが何から
  来ているかを併記しました。どちらで選んでも同じものです。
