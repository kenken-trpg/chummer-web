...
| Chemicals | 化学薬品 |
| Combat Active | 戦闘能動 |
| Commlink Accessories | コムリンク・アクセサリ |
| Cosmetic | 美容整形 |
| Crossbows | クロスボウ |
| Cultured | 培養 |
| Cyberdecks | サイバーデッキ |
...
| Hovercraft | ホバークラフト |
| ID/Credsticks | ID/クレッドスティック |
| Laser Weapons | レーザー武器 |
| Magical Active | 魔法能動 |
| Magical Compounds | 魔法化合物 |
| Magical Supplies | 魔法用品 |
...
| Positive | 有利 |
| RFID Tags | RFIDタグ |
| Resonance Active | 共振能動 |
| Rotorcraft | 回転翼機 |
| Security Devices | セキュリティ機器 |
| Sensors | センサー |
| Shapeshifter | シェイプシフター |
| Skillsofts | スキルソフト |
| Social Active | 社交能動 |
| Technical Active | 技術能動 |
| Tools | 工具 |
| Toxins | 毒物 |
| Trucks | トラック |
| Unarmed | 素手 |
...
| Chemical Seal | 化学遮断 |
| Chicken | ニワトリ |
| Clean Metabolism | クリーン代謝系 |
| Cleansing | 浄化術 |
| Colt Manhunter | コルト マンハンター |
| Commanding Voice | 命令の声 |
| Control Emotions | 感情制御 |
| Corruption | 堕落術 |
| Coyote | コヨーテ |
| Cybergland | サイバー分泌腺 |
| Dark King | 冥王 |
