...
sr5eja 列: `＝` = 採用と一致 / `≠` = 採用と相違。sr5eja の訳語自体は収録しない（無ライセンスのため参照のみ）。
...
| Action | アクション |  | ＝ |  |
| Action Type | タイプ |  | ＝ |  |
| Action Type Complex | 複雑 |  | ＝ |  |
| Action Type Free | 簡易 |  | ＝ |  |
| Action Type None | なし |  | ＝ |  |
| Action Type Simple | 単純 |  | ＝ |  |
| Action Type Varies | 変動 |  | ＝ |  |
| Actions | 行動 |  | ＝ |  |
| Active | 能動 |  | ＝ |  |
| Active Defense | 能動防御 |  | ＝ |  |
| Active Skills | 能動技能 | 能動技能 | ＝ |  |
| Add | 追加 |  | ＝ |  |
| Add Ammo | 弾薬を追加 |  | ＝ |  |
...
| Complex Form | 複合体 | 複合体 | ＝ |  |
| Complex Forms | 複合体 | 複合体 | ＝ |  |
| Composure | 冷静テスト | 冷静テスト |  |  |
| Conceal | 隠蔽 |  | ＝ |  |
| Condition Monitor | コンディション・モニター |  | ＝ |  |
| Connect To Network | ネットワークに接続 |  | ＝ |  |
| Connection | コネ値 | コネ値 | ≠ | 差異 |
| Contact | コンタクト | コンタクト | ≠ | 手動確定 / 差異 |
| Contact Drug | 接触 | 接触 |  |  |
| Contact Type | 種類 |  | ＝ |  |
| Contacts | コンタクト |  | ＝ |  |
| Continue | 続行 |  | ＝ |  |
...
| Damage | ダメージ(DV) | ダメージ(DV) | ≠ | 差異 |
| Damage Replace | ダメージ置換 |  | ＝ |  |
| Damage Type | ダメージタイプ | ダメージタイプ | ≠ | 差異 |
| Damage Value | ダメージ値 |  | ＝ |  |
...
| Duration Permanent | 永続 |  | ＝ |  |
| Duration Sustained | 維持 |  | ＝ |  |
| E | 超遠距離-6 | 超遠距離-6 |  |  |
| Echo | エコー |  | ＝ |  |
| Echoes | エコー |  | ＝ |  |
| EDG | エッジ | エッジ |  |  |
...
| Ingestion | 経口 | 経口 |  |  |
| Inhalation | 吸入 | 吸入 |  |  |
| Init Cat Astral | アストラル |  | ＝ |  |
| Init Cat Matrix | マトリックス |  | ＝ |  |
| Init Cat Meatspace | 物理 |  | ＝ |  |
| Initiation | 階梯 |  | ＝ |  |
| Initiative | イニシアティブ | イニシアティブ | ＝ |  |
| Injection | 注入 | 注入 |  |  |
| INT | 直観 | 直観 |  | 手動確定 |
| Internal | 内蔵 |  | ＝ |  |
...
| Matrix Attr Attack | アタック |  | ＝ |  |
| Matrix Attr Data Proc | データ処理 |  | ＝ |  |
| Matrix Attr Firewall | ファイアウォール |  | ＝ |  |
| Matrix Attr Sleaze | スリーズ |  | ＝ |  |
...
| Physical Track | 身体ダメージトラック | 身体ダメージトラック | ≠ | 差異 |
...
| Source | 資料 |  | ＝ |  |
| Spare Clips | 予備クリップ |  | ＝ |  |
| Special Attributes | 特殊能力値 | 特殊能力値 | ＝ |  |
| Specialization | 専門化 |  | ＝ |  |
| Specializations | 専門化 |  | ＝ |  |
| Speed | 最高速度 | 最高速度 |  |  |
| Spell | 呪文 | 呪文 | ＝ |  |
...
| Stock | ストック |  | ＝ |  |
| STR | 筋力 | 筋力 |  |  |
| Street Cred | ストリートの評判 | ストリートの評判 | ＝ |  |
| Strength | 筋力 | 筋力 |  |  |
| Stun | 精神 | 精神 |  |  |
| Stun Natural Recovery | 精神自然回復(1 時間) | 精神自然回復(1 時間) |  |  |
| Stun Track | 精神ダメージトラック | 精神ダメージトラック | ≠ | 差異 |
| Submersion | サブマージョン |  | ＝ |  |
| Successes | 成功 |  | ＝ |  |
| Suppressing | 制圧 |  | ＝ |  |
| Swim | 水泳 | 水泳 |  |  |
