...
import { CATS, LETTERS, SUM_TO_TEN_COST } from "@/lib/character/constants";
...
export function PriorityTab({
  ...
  return (
    <>
      <SettingsPicker catalog={catalog} character={ch} ui={ui} tr={tr} patch={patch} />
      <div className="card">
        <div
          style={{
            display: "flex",
        ...
        >
          <button
            ...
            onClick={() => patch(buildMethodPatch("Priority", ch))}
          >
          ...
          <button
            ...
            onClick={() => patch(buildMethodPatch("SumToTen", ch))}
          >
          ...
          <button
            ...
            onClick={() => patch(buildMethodPatch("Karma", ch))}
          >
