          ...
          <div className="card">
            ...
            {(ch.build_method || "Priority") === "Karma" ? (
              <div style={{ display: "grid", gap: 12 }}>
                <p className="muted">
                  優先度表は使いません。メタ／能力値／技能／術式などをカルマで購入します（開始 {d.karma.pool}）。
                ...
                {d.karma_chargen ? (
                  <div className="muted" style={{ display: "grid", gap: 4 }}>
                    <div>内訳: メタ {d.karma_chargen.metatype} / 能力値 {d.karma_chargen.attributes} / 技能 {d.karma_chargen.skills} / 知識 {d.karma_chargen.knowledge} / 専門化 {d.karma_chargen.specializations}</div>
